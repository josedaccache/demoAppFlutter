...
class MessageInput extends StatelessWidget{
  ...
  const MessageInput({Key key, this.focusNode, this.unfocusedColor, this.controller}) : super(key: key);
    ...
    return BlocBuilder<ContactUsFormBloc, ContactUsFormState>(
      builder: (context, state) {
        return TextFormField(
          ...
          onChanged: (value) {
            context.read<ContactUsFormBloc>().add(MessageChanged(message: value));
          },
